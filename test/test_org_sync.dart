...
void main() async {
  ...
  try {
    ...
    if (tokenResponse.statusCode == 200) {
      ...
      print(
        'Access Token obtained: ${accessToken.substring(0, 10)}... (truncated)',
      );
      ...
      if (orgResponse.statusCode == 200) {
        ...
        print(
          'Failed fetching organization: ${orgResponse.statusCode} - ${orgResponse.statusMessage}',
        );
      }
    } else {
      print(
        'Failed refreshing access token: ${tokenResponse.statusCode} - ${tokenResponse.statusMessage}',
      );
    }
  } catch (e) {
