...
/// Screen listing all recorded Sales Orders.
///
/// Features a double date-picker filter row (Start / End Date) to narrow down items,
/// a visual summary of results, and floating actions to edit or launch new orders.
...
class _SalesOrderListPageState extends State<SalesOrderListPage> {
  ...
  void _clearFilters() {
    context.read<SalesOrderBloc>().add(const SetDateFilter(startDate: null, endDate: null));
  }
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          hasFilter ? 'Try expanding your date range filters.' : 'Click "+" below to generate your first sales order.',
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          '$cs${order.total.toStringAsFixed(2)}',
                                          style: const TextStyle(
