                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Taxes (GST):', style: TextStyle(fontSize: 13)),
                        Text('₹${cartTaxTotal.toStringAsFixed(2)}'),
                      ],
                    ),
                    const SizedBox(height: 4),
                    Row(
                          ...
                          : () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  ...
                                  content: Text('Invoice generated & queued offline! Subtotal: ₹${cartTotal.toStringAsFixed(2)}'),
                                ),
                              );
