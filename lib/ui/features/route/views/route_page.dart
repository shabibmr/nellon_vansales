...
import '../cubit/route_selection_ui_cubit.dart';
import '../cubit/route_selection_ui_state.dart';
...
class RouteSelectionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<RouteSelectionUiCubit>(
      create: (_) => RouteSelectionUiCubit(),
      child: const _RouteSelectionView(),
    );
  }
}

class _RouteSelectionView extends StatelessWidget {
  const _RouteSelectionView();
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              context.read<RouteSelectionUiCubit>().clearSelection();
            },
          ),
        ],
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: BlocBuilder<RouteBloc, RouteState>(
                  builder: (context, routeState) {
                    ...
                    return BlocBuilder<RouteSelectionUiCubit, RouteSelectionUiState>(
                      builder: (context, uiState) {
                        return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final isSelected = uiState.selectedRouteId == route.id;

                            return InkWell(
                              onTap: () {
                                context
                                    .read<RouteSelectionUiCubit>()
              ...
              BlocBuilder<RouteSelectionUiCubit, RouteSelectionUiState>(
                builder: (context, uiState) {
                  return ElevatedButton(
                    onPressed: uiState.selectedRouteId == null
                        ? null
                        : () {
                            context.read<RouteBloc>().add(
                              SelectActiveRoute(uiState.selectedRouteId),
                            );
                          },
