...
class FakeSalesRepository implements SalesRepository {
  ...
  List<RouteModel> getRoutes() => [
    const RouteModel(id: 'rt_01', name: 'Downtown Route Sequence A', description: 'Downtown route sequence'),
  ];
...
void main() {
  ...
  group('Van Sales End-to-End UI Integration Test', () {
    ...
    testWidgets('Verify complete application login sequence and route picker loading', (WidgetTester tester) async {
